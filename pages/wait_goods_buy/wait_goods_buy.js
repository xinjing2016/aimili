       ...
       pay_type=3;
        var amount=that.data.add_price;  //支付的金额
           ...
           wx.request({  //查看用户名         
            ...
            success: function(res){
            var new_name =res.data.data;
            var order_account=that.data.order_account;
             ...
             if(new_name== order_account){
               ...
               wx.request({  // 查看当前拼团订单状态         
              url: 'https://www.gaoliuxu.com/index.php/Home/Index/wait_goods_buy_state',
               data: {
          ...
          url: 'https://www.gaoliuxu.com/index.php/Home/Index/group_shopping',
                      data: {
                        ...
                        method: 'GET',
          header: {  // 设置请求的header
          'Cookie' : wx.getStorageSync('account'),    "Content-Type": "application/x-www-form-urlencoded"
                        }, 
                        success: function(res){//参与团购成功
                  if(res.data.errorcode==0){
  ...
  //等待团购的请求 
    wx.request({
      ...
      success: function(res){     
        ...
        var order_id=order['order_id'];  //发起团购的订单id
        var order_account=order['account']; //发起团购的用户
    ...
    console.log(order_id);
      ...
      that.data.order_goods[0]["price"]=goods["yuanjia"];
      that.data.order_goods[0]["discount_price"]=goods["tuangou"];
     ...
     that.data.order_goods[0]["checked"]="true";
        ...
        that.setData({
         order_goods:that.data.order_goods,
         add_price:toDecimal(goods["tuangou"]),
         discount:toDecimal(goods["yuanjia"]-goods["tuangou"]),
         order_id:order_id,
